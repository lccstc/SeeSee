...
class WebAppTests(PostgresTestCase):
    ...
    def test_quotes_page_renders_board_and_exception_sections(self) -> None:
        ...
        self.assertIn('class="quote-desk-zone quote-desk-intro"', body)
        self.assertIn('class="quote-desk-zone quote-desk-workflow"', body)
        self.assertIn('class="quote-desk-zone quote-desk-current-state"', body)
        ...
        self.assertIn("这里看已经进入主线解析的群口径", body)
        self.assertIn("只有在有效期内的上下文才会接住下一条裸价", body)
